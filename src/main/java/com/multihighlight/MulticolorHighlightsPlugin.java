...
public class MulticolorHighlightsPlugin extends Plugin
{
	...
	{
		log.info("Multicolor Highlights started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Multicolor Highlights stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Multicolor Highlights says " + config.greeting(), null);
		}
	}
